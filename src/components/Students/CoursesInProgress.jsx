...
const courses = [
  ...
  {
    id: 3,
    title: { en: "German A1 Listening", de: "Deutsch A1 Hoeren" },
    imageUrl: "https://via.placeholder.com/100",
    lastActive: { en: "3 days ago", de: "Vor 3 Tagen" },
    progress: 58,
  },
  {
    id: 4,
    title: { en: "German Verb Practice", de: "Deutsche Verben" },
    imageUrl: "https://via.placeholder.com/100",
    lastActive: { en: "today", de: "Heute" },
    progress: 63,
  },
];
