      ...
      <div className="bg-card rounded-lg shadow-lg p-6">
        ...
        <div className="flex justify-end gap-4 mt-4">
          <button
            ...
            className="px-6 py-2 bg-muted rounded-md hover:bg-muted/80 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
        ...
        {showSaved && (
          <div className="mt-6 border-t border-border pt-6">
            <h3 className="text-lg font-semibold mb-4">{t("dictionary.savedWords")}</h3>
